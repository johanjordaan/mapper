...
(function() {
  ...
  define(['../lib/mapper', '../lib/junction'], function(mapper, junction) {
    ...
    load_all = function(store, store_funcs, map, callback) {
      ...
      ret_val = [];
      junction.call(load_all_j, load_collection, store, store_funcs, map.default_collection, function(object_ids) {
        var id, _i, _len, _results;
        if (object_ids != null) {
          _results = [];
          for (_i = 0, _len = object_ids.length; _i < _len; _i++) {
            id = object_ids[_i];
            _results.push(junction.call(load_all_j, load, store, store_funcs, map, id, function(loaded_object) {
