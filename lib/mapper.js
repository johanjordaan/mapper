...
(function() {
  ...
  define([], function() {
    var apply, create, exports, flatten, update;
    ...
    flatten = function(map, obj, stack) {
      var actions, dict;
      if (stack == null) {
        stack = [];
      }
        ...
        'List': function(field_name, field_def, obj, source) {
          ...
          if (field_def.internal) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              item = _ref[_i];
              _results.push(flatten(field_def.map, item, stack));
            }
            return _results;
          }
        },
        'Ref': function(field_name, field_def, obj, source) {
          if (field_def.internal) {
            if (obj[field_name] != null) {
              return flatten(field_def.map, obj[field_name], stack);
            }
          }
        }
      });
    ...
    update = function(map, obj, source) {
      ...
      for (field_name in _ref) {
        field_def = _ref[field_name];
        if (field_def.default_value != null) {
